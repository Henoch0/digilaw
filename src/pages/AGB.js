...
`text-gray-900 dark:text-gray-400 mb-10`;
    ...
    return (
      ...
      <Container>
        <ContentWithPaddingXl>
          ...
          <Text>
          Allgemeine Geschäftsbedingungen der Firma Drip N Law<br/>
...
(1) Die folgenden Regelungen über den Vertragsabschluss gelten für Bestellungen über unseren Internetshop https://dnlclothing.herokuapp.com/ .<br/>
<br/>
...
E-Mail zu. Die AGB können Sie jederzeit auch unter https://dnlclothing.herokuapp.com/agb  einsehen.
...
<b>
    ...
    <div style="margin-left:20px; margin-top: 5px; margin-bottom:5px;">
        ...
        Sapporoweg 8-6<br/>
        D-80933 München<br/>
        E-Mail DNP-support@outlook.de<br/>
            </div>
...
Wir tragen die Kosten der Rücksendung der Waren<br/>
<br/>
