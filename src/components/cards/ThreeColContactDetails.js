...
const Description = tw(SectionDescription)`w-full text-center dark:text-gray-900`;
...
const Card = styled.div`
  ...
  .title {
    ${tw`mt-4 tracking-wide font-bold text-2xl leading-none text-blue-400`}
  }

  .description {
    ${tw`mt-1 sm:mt-4 font-medium text-secondary-100 leading-loose dark:text-gray-300`}
  }
`;
